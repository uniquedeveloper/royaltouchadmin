                ...
                <div class="owl-carousel">
                    <div class="carousel-item">
                        ...
                        <video autoplay muted loop>
                            <source src="img/157_1-video.mp4" type="video/mp4">
    ...
    <section class="about">
        ...
        <div class="service">
            ...
            <div class="box">
                ...
                <div class="heading">Premium quality </div>
                <div class="text">Sed do eiusm od tempor </div>
            </div>

            <div class="box">
                <div class="icon"><i class="fas fa-id-card"></i></div>
                <div class="heading">Lisence & insurance </div>
                <div class="text">Sed do eiusm od tempor </div>
            </div>

            <div class="box">
                <div class="icon"><i class="fas fa-id-card"></i></div>
                <div class="heading">Certified experts </div>
                <div class="text">Sed do eiusm od tempor</div>
            </div>

            <div class="box">
                <div class="icon"><i class="fas fa-car"></i></div>
                <div class="heading">Range of service </div>
                <div class="text">Sed do eiusm od tempor </div>
            </div>
        </div>
        ...
        <section class="container-fluid">
            <div class="row no-gutters">
                ...
                <div class="col-md-6 columnimg" style="background-image: url('https://detailx.ancorathemes.com/wp-content/uploads/2023/08/image14-copyright.jpg');">
                    <div class="overlay"></div> 
                    <div class="sc_cod_item_content_inner"> 
                        <div class="sc_cod_item_content_inner_center">  
                            <p class="sc_cod_item_text ">GET IN TOUCH</p>
                            <h2 class="sc_cod_item_title">HAVE A PROBLEM?</h2>
                ...
                <!-- Column 2 -->
                <div class="col-md-6 columnimg" style=" background-image: url('https://detailx.ancorathemes.com/wp-content/uploads/2023/08/image15-copyright.jpg');">
                    <div class="overlay"></div> 
                    <div class="sc_cod_item_content_inner"> 
                        <div class="sc_cod_item_content_inner_center">  
                            <p class="sc_cod_item_text ">CAREERS</p>
                            <h2 class="sc_cod_item_title">WANT TO WORK WITH US?</h2>
        ...
        <div class="contact">
            <div class="container">
                ...
                <div class="col-md-7" >
                    ...
                    <img decoding="async" width="100%" src="https://detailx.ancorathemes.com/wp-content/uploads/2023/08/image16-copyright.jpg" title="" alt="" loading="lazy">
                </div>
                <!-- Form Column -->
                <div class="col-md-5" style="display: flex;align-items: flex-start;flex-direction: column;justify-content: center;">
                    <div class="sc_title_default">
                            <span class="sc_item_title_style_default">
                                Contact Us
                            </span>
                            <h1 class="sc_item_title sc_title_title ">
    ...
    <!-- Testimonial Start -->
        <div class="testimonial">
            <div class="container">
                <div class="section-header text-center">
                    <p>Testimonial</p>
                    <h2 style="color:white !important;">What our clients say</h2>
                </div>
